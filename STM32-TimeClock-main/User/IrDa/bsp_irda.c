...
void IrDa_Init(void)
{
  ...
  GPIO_InitStructure.Pin = IRDA_GPIO_PIN;       
  GPIO_InitStructure.Mode = GPIO_MODE_INPUT;
  GPIO_InitStructure.Pull = GPIO_NOPULL;	
  HAL_GPIO_Init(IRDA_GPIO_PORT, &GPIO_InitStructure);

	/* EXTI line mode config */
  GPIO_EXTILineConfig(RCC_APB2Periph_GPIOA, IRDA_GPIO_PIN_SOURCE); 
